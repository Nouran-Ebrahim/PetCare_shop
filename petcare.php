    ...
    <body>
        <!-- nav bar -->
            <div id="header">
                ...
                <div class="nav-bar"><a class="btn btn-secondary " href="stories.php">Stories</a></div>
                <div class="nav-bar"><a class="btn btn-secondary"  href="petcare.html">Pet care</a></div>
            ...
            <nav class="navbar navbar-light pos" id="search_se">
              ...
              <div class="doctor_welcome">
                <img src="images/petcarebg.jpg"> 
                <div id="doctor_icon">
                  <i class="fa fa-user-md" ></i>
                  <div id="doctor_wel">HELLOW USERNAME</div>
                </div>
                <button id="livecaht">LIVE CHATE</button>
              </div>
              <div id="petcare_container"></div>
               <div id="left_care">
                    <div id="docPhoto"><img src="images/docPhoto.png"></div>
                    <div id="doc_name"></div>
                    <div id="doc_mob"></div>
                    <div id="doc_email"></div>
                    <div id="doc_address"></div>
               </div>
               <div id="right">
                 <!-- masseges from user -->
               </div>
